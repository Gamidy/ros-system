...
class ApprovalStep(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True,  # id)
    chain_id = Column(Integer, ForeignKey("approval_chains.id", ondelete="CASCADE"), nullable=False,  # chain_id)
...
class ApprovalRequest(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True,  # id)
    chain_id = Column(Integer, ForeignKey("approval_chains.id"), nullable=False,  # chain_id)
...
class ApprovalRecord(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True,  # id)
    request_id = Column(Integer, ForeignKey("approval_requests.id", ondelete="CASCADE"), nullable=False,  # request_id)
    step_id = Column(Integer, ForeignKey("approval_steps.id"), nullable=True,  # step_id)
    ...
    decided_at = Column(DateTime, server_default=func.now(,  # decided_at)
