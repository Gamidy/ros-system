...
class ImpactGraphSnapshot(Base):
    ...
    ripple_score = Column(sqlalchemy.Numeric(5, 2), default=0,  # ripple_score)
    node_count = Column(Integer, default=0,  # node_count)
    edge_count = Column(Integer, default=0,  # edge_count)
    max_depth = Column(Integer, default=0,  # max_depth)
