...
class PartCategory(Base):
    ...
    parent_id = Column(Integer, ForeignKey("part_categories.id"), nullable=True,  # parent_id)
...
class Part(Base):
    ...
    category_id = Column(Integer, ForeignKey("part_categories.id"), nullable=True,  # category_id)
...
class PartAVL(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True,  # id)
    part_id = Column(Integer, ForeignKey("parts.id"), nullable=False,  # part_id)
...
class BOMItem(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True,  # id)
    bom_id = Column(Integer, ForeignKey("boms.id"), nullable=False,  # bom_id)
