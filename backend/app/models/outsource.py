...
class OutsourceOrder(Base):
    ...
    partner_id = Column(Integer, ForeignKey("outsource_partners.id", ondelete="CASCADE"), nullable=False)
...
class OutsourceOrderItem(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    order_id = Column(Integer, ForeignKey("outsource_orders.id", ondelete="CASCADE"), nullable=False)
...
class OutsourceQualityFile(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    record_id = Column(Integer, ForeignKey("outsource_quality_records.id", ondelete="CASCADE"), nullable=False)
