...
class RiskAssessment(Base):
    ...
    # 5个信号维度分
    bom_impact = Column(Numeric(5, 2), default=0)
    cert_impact = Column(Numeric(5, 2), default=0)
    proto_instability = Column(Numeric(5, 2), default=0)
    cost_overrun = Column(Numeric(5, 2), default=0)
    hist_failure_rate = Column(Numeric(5, 2), default=0)
