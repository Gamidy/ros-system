...
class MarketParamConfig(Base):
    ...
    market_code = Column(String(20), ForeignKey("markets.code", ondelete="CASCADE"), nullable=False, index=True,
                         comment="市场代码")
    ...
    data_type = Column(String(20), nullable=False, server_default="float",
                       comment="数据类型: float/int/string/select")
    sort_order = Column(Integer, nullable=False, server_default="0", comment="排序")
    is_required = Column(String(5), nullable=False, server_default="false")
