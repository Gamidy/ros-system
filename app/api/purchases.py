...
from app.models.purchase import PurchaseOrder, PurchaseOrderItem, OutsourceRequest
...
# 引入子模块（供应商管理、收货管理），路由器由 main.py 统一注册
from app.api import purchases_supplier, purchases_receipt  # noqa: F401
...
def purchase_dashboard(db: Session = Depends(get_db), _=Depends(require_menu("purchases"))) -> PurchaseDashboardOut:
    ...
    return PurchaseDashboardOut(
        ...
        total_suppliers=db.query(PurchaseOrder).count(),  # placeholder, real count in supplier module
